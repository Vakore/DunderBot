...
function dunderTaskInitialize(bot) {
    ...
    //TODO: fix the "mines extra block" patchy fix, and exploring if can't find anything
    createDunderTask(bot, "mine", {"block":(block) => (block.name.includes("_log") /*&& blockExposed(bot, block)*/), "distance":120, "count":4, "useExtraInfo":true, "finishCondition":4, "itemCondition":function(itemName) {return itemName.includes("_log");}});
    ...
    //TODO: crafting table manager, we don't need to break this
    ...
    //TODO: fix the "won't mine through grass block" issue!
    ...
    createDunderTask(bot, "mine", {"block":(block) => (block.name.includes("_log") /*&& blockExposed(bot, block)*/), "distance":120, "count":5, "useExtraInfo":true, "finishCondition":2, "itemCondition":function(itemName) {return itemName.includes("_log");}});
